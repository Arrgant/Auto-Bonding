...
from core import BondPoint, CoordinateExporter


class TestCoordinateExporter:
    """Coordinate exporter tests."""
    ...
    def test_export_asm(self):
        exporter = CoordinateExporter()
        points = [BondPoint(1.0, 2.0, 3.0, wire_type=1)]
    ...
    def test_export_shinkawa(self):
        exporter = CoordinateExporter()
        points = [BondPoint(10.0, 20.0, 30.0, wire_type=1)]
    ...
    def test_export_unsupported_format(self):
        ...
        try:
            result = exporter.export(cq.Assembly(), temp_path, "UNSUPPORTED")
